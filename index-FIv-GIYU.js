 ...
 */ (function (e) {
  ...
  function r(E) {
    ...
    if (z !== P) {
      E[0] = z;
      e: for (var W = 0, X = E.length, bt = X >>> 1; W < bt; ) {
        var yn = 2 * (W + 1) - 1,
          gl = E[yn],
          gn = yn + 1,
          er = E[gn];
        if (0 > l(gl, z))
          gn < X && 0 > l(er, gl)
            ? ((E[W] = er), (E[gn] = z), (W = gn))
            : ((E[W] = gl), (E[yn] = z), (W = yn));
        else if (gn < X && 0 > l(er, z)) (E[W] = er), (E[gn] = z), (W = gn);
        else break e;
      }
    }
    return P;
    ...
    (e.unstable_scheduleCallback = function (E, P, z) {
      ...
      return (
        ...
        z > W
          ...
          : ((E.sortIndex = X), n(s, E), w || g || ((w = !0), vl(x))),
        E
      );
    }),
...
function Uc(e, n, t, r, l, o, i, u, s) {
  (Et = !1), (Rr = null), Fc.apply(Ic, arguments);
}
...
var Fr = null;
function co(e, n, t, r) {
  if (((Fr = null), (e = Xo(r)), (e = Sn(e)), e !== null))
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Vt], delete n[go], delete n[Gf], delete n[Xf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
const Rd = ({ frase: e, handleClick: n }) => {
  const { id: t, advice: r } = e;
  return j.jsxs("div", {
    id: "card",
    className:
      "text-center bg-darkGrayBlue font-manrope w-[90%] max-w-[575px] rounded-xl shadow-md relative",
    children: [
      j.jsxs("div", {
        className: "p-4 lg:px-10",
        children: [
          j.jsxs("h2", {
            className:
              "text-neonGreen text-xs my-7 md:my-8 tracking-[3px] md:text-sm",
            children: ["ADVICE ", t],
          }),
          j.jsx("p", {
            className: "text-lightCyan text-2xl md:text-3xl md:leading-10",
            children: r,
          }),
          j.jsxs("div", {
            className:
              "flex gap-5 justify-evenly items-center mt-8 md:mt-12 pb-10 md:pb-14",
            children: [
              j.jsx("svg", {
                width: "295",
                height: "16",
                ...
                children: j.jsxs("g", {
                  ...
                  children: [
                    ...
                    j.jsxs("g", {
                      ...
                      fill: "#CEE3E9",
                      children: [
                        j.jsx("rect", { width: "6", height: "16", rx: "3" }),
                        j.jsx("rect", {
                          x: "14",
                          width: "6",
                          height: "16",
      ...
      j.jsx("button", {
        onClick: n,
        className:
          "absolute bottom-[-1.75rem] right-1/2 translate-x-1/2 bg-neonGreen w-14 h-14 flex items-center justify-center rounded-full hover:shadow-lg hover:shadow-neonGreen",
        children: j.jsx("svg", {
          width: "24",
          height: "24",
          xmlns: "http://www.w3.org/2000/svg",
...
function jd() {
  const e = "https://api.adviceslip.com/advice",
    [n, t] = qe.useState({}),
    [r, l] = qe.useState(!1),
    [o, i] = qe.useState(),
    u = qe.useRef(null),
    s = async () => {
      var h, m;
      (h = u.current) == null || h.abort(),
        (u.current = new AbortController()),
        l(!0);
      try {
        const g = await (
          await fetch(`${e}`, {
            signal: (m = u.current) == null ? void 0 : m.signal,
          })
        ).json();
        t(g.slip);
      } catch (p) {
  ...
  return o
    ? j.jsxs("div", {
        id: "container",
        className:
          "h-screen flex flex-col justify-center items-center bg-darkBlue",
        children: [
          j.jsx("h2", {
            className:
              "text-neonGreen text-xs my-7 md:my-8 tracking-[3px] md:text-sm",
    ...
    : j.jsx(j.Fragment, {
        children: j.jsx("div", {
          ...
          className:
            "h-screen flex flex-col justify-center items-center bg-darkBlue",
          children: j.jsx(Rd, { frase: n, handleClick: c }),
        }),
      });
}
