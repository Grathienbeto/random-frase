export const FraseCard = ({ frase, handleClick }) => {
  const { id, advice } = frase;
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handleClick}
        className="absolute bottom-[-1.75rem] right-1/2 translate-x-1/2 bg-neonGreen w-14 h-14 flex items-center justify-center rounded-full hover:shadow-lg hover:shadow-neonGreen"
      >
